   ...
   <section className=" left-sec z-10 relative h-full w-2/3 flex items-center justify-center bg-[#172229] ">
    <img src={heroImg} alt="" className='relative block object-cover h-full w-full'/> 
        <div className="icons flex items-center justify-center top-50 left-50 z-10">
           ...
           <h1 className='p-3 rounded-full bg-[#FFE7D9] absolute top-70 left-100'> <FaPlus /></h1>
        </div>  

        <div className="content absolute translate-y-40 h-50 w-150 text-[#FFE7D9] z-10 ">
            ...
            <p className='line-clamp-3 px-5 font-semibold '>Discover a haven of refined urban living in our luxurious loft residences. Nestled in the vibrant heart of the city, these contemporary homes offer a seamless blend of modern design and convenience.</p>
        </div>
   </section>
  )
}
