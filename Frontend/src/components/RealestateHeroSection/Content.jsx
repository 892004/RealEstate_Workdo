...
const Content = (props , idx) => {
  ...
  return (
    <section className="content absolute flex flex-col gap-8 top-0 text-white px-27 py-15">
        ...
        <div className="artical-buttons flex flex-row text-sm gap-10  px-3">
            <p className=' btn-1 bg-[#172229] px-3 py-2 rounded-full'>Featured</p>
        ...
        <p className='artical-heading px-3 text-[33px] text-base/10 font-bold'>{props.title}</p>

        <p className='artical-para px-3 w-150 line-clamp-4'>{props.para}
</p>
    </section>       
  )
}
